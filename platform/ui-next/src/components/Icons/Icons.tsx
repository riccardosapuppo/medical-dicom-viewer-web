...
import Printer from './Sources/Printer';
import {
  Tool3DRotate,
  ToolAngle,
  ToolAnnotate,
...
export const Icons = {
  ...
  mprDirect: ({ className, ...props }: ImageIconProps) => (
    <span className="relative inline-flex items-center justify-center leading-none">
      ...
      />
      <span
        className="mpr-icon-badge pointer-events-none absolute font-bold"
        style={{
          right: 0,
          bottom: '2px',
          fontSize: '7px',
  ...
  'tool-montage': (props: IconProps) => ToolMontage(props),
