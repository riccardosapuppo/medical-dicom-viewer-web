...
function Header({
  ...
  return (
    <NavBar
      ...
      {...props}
    >
      <div className="mdv-testata relative h-[48px] items-center">
        ...
        <div className="div-patient-info absolute right-0 top-1/2 flex -translate-y-1/2 select-none items-center">
          {PatientInfo}
